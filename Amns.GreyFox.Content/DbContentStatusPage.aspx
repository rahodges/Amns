...
<%@ Page language="c#" CodeFile="DbContentStatusPage.aspx.cs" Inherits="Amns.GreyFox.ContentWeb.Administration.DbContentStatusPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DbContentStatusGrid id="DbContentStatusGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DbContentStatusGrid>
									<cc1:DbContentStatusEditor id="DbContentStatusEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DbContentStatusEditor>
									<cc1:DbContentStatusView id="DbContentStatusView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DbContentStatusView>
								</td>
							</tr>
							<tr>
