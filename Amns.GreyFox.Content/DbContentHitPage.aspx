...
<%@ Page language="c#" CodeFile="DbContentHitPage.aspx.cs" Inherits="Amns.GreyFox.ContentWeb.Administration.DbContentHitPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DbContentHitGrid id="DbContentHitGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DbContentHitGrid>
									<cc1:DbContentHitEditor id="DbContentHitEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DbContentHitEditor>
									<cc1:DbContentHitView id="DbContentHitView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DbContentHitView>
								</td>
							</tr>
							<tr>
