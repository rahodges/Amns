...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DbContentRating.
	/// </summary>
	/// </summary>
	[ToolboxData("<DbContentRating:DbContentRatingDeleteDialog runat=server></{0}:DbContentRatingDeleteDialog>")]
	public class DbContentRatingDeleteDialog : TableWindow
	{

		private int dbContentRatingID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dbContentRatingID == 0)
			{
				...
				output.Write("The DbContentRating selected does not exist.");
			...
			output.Write("<strong>Warning:</strong> This action deletes the selected Rating." +
