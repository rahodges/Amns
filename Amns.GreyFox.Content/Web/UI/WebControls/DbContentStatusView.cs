...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	...
	[DefaultProperty("ConnectionString"), 
		ToolboxData("<{0}:DbContentStatusView runat=server></{0}:DbContentStatusView>")]
	public class DbContentStatusView : TableWindow, INamingContainer
	{
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			RenderCell("DbContentStatus ID", "class=\"row1\"");
			RenderCell(dbContentStatusID.ToString(), "class=\"row1\"");
