...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DbContentComment.
	/// </summary>
	/// </summary>
	[DefaultProperty("ConnectionString"),
		ToolboxData("<{0}:DbContentCommentDeleteDialog runat=server></{0}:DbContentCommentDeleteDialog>")]
	public class DbContentCommentDeleteDialog : TableWindow
	{
		private string connectionString;

		private int dbContentCommentID = -1;
		...
		{
			DbContentComment dbContentComment = new DbContentComment(dbContentCommentID);
			dbContentComment.Delete();

			dbContentCommentID = 0;
		...
		protected override void OnPreRender(EventArgs e)
		{
			...
			if(dbContentCommentID != 0)
			{
				...
				text = "Delete - " + dbContentComment.ToString();
			}
			else
			{
				text = "Delete ";
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dbContentCommentID == 0)
			{
				...
				output.Write("The DbContentComment selected does not exist.");
