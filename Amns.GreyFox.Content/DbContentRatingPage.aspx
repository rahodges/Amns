...
<%@ Page language="c#" CodeFile="DbContentRatingPage.aspx.cs" Inherits="Amns.GreyFox.ContentWeb.Administration.DbContentRatingPage" trace="false" %>
							...
							<tr>
								<td vAlign="top">
									<table id="LeftMenu" class="forumLine" cellSpacing="1" cellPadding="3" width="200" border="0">
										<tr><th>Rating</th></tr>
										<tr><td>Rating can be accessed here</td></tr>
									</table>
								</td>
								<td vAlign="top" width="100%">
									<cc1:DbContentRatingGrid id="DbContentRatingGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text="Rating"
										></cc1:DbContentRatingGrid>
									<cc1:DbContentRatingEditor id="DbContentRatingEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text="Rating Editor"
										></cc1:DbContentRatingEditor>
									<cc1:DbContentRatingView id="DbContentRatingView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text="Rating View"
										></cc1:DbContentRatingView>
								</td>
							</tr>
							<tr>
