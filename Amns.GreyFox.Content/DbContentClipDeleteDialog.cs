...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DbContentClip.
	/// </summary>
	/// </summary>
	[ToolboxData("<DbContentClip:DbContentClipDeleteDialog runat=server></{0}:DbContentClipDeleteDialog>")]
	public class DbContentClipDeleteDialog : TableWindow
	{

		private int dbContentClipID = -1;
		...
		{
			DbContentClip dbContentClip = new DbContentClip(dbContentClipID);
			dbContentClip.Delete();
		...
		protected override void OnPreRender(EventArgs e)
		{
			if(dbContentClipID != 0)
			{
				...
				text = "Delete - " + dbContentClip.ToString();
			}
			else
			{
				text = "Delete ";
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dbContentClipID == 0)
			{
				...
				output.Write("The DbContentClip selected does not exist.");
