...
namespace Amns.GreyFox.Content
{
	...
	/// </summary>
	public class DbContentCommentManager
	{
		...
		public void CreateTable()
		{
			...
			if (database.ConnectionStringWithoutCredentials.StartsWith("provider=microsoft.jet.oledb.4.0"))
			{
				...
				query.Append(" (DbContentCommentID COUNTER(1,1) CONSTRAINT PK_kitCms_Comments PRIMARY KEY, " +
					"CreateDate DATETIME," +
					"ModifyDate DATETIME," +
					"Name TEXT(50)," +
					"Email TEXT(50)," +
			...
			else
			{
				// Microsoft SQL Server
				query = new StringBuilder("CREATE TABLE kitCms_Comments ");
				query.Append(" (DbContentCommentID INT IDENTITY(1,1) CONSTRAINT PK_kitCms_Comments PRIMARY KEY, " +
					"CreateDate DATETIME," +
					"ModifyDate DATETIME," +
					"Name NVARCHAR(50)," +
					"Email NVARCHAR(50)," +
