...
namespace Amns.GreyFox.Content
{
	...
	/// </summary>
	public class DbContentStatusManager
	{
		...
		public void CreateTable()
		{
			...
			if (database.ConnectionStringWithoutCredentials.StartsWith("provider=microsoft.jet.oledb.4.0"))
			{
				...
				query.Append(" (DbContentStatusID COUNTER(1,1) CONSTRAINT PK_kitCms_Statuses PRIMARY KEY, " +
					"Name TEXT(75)," +
					"IsDraft BIT," +
					"IsPublished BIT," +
					"FeeEnabled BIT," +
			...
			else
			{
				// Microsoft SQL Server
				query = new StringBuilder("CREATE TABLE kitCms_Statuses ");
				query.Append(" (DbContentStatusID INT IDENTITY(1,1) CONSTRAINT PK_kitCms_Statuses PRIMARY KEY, " +
					"Name NVARCHAR(75)," +
					"IsDraft BIT," +
					"IsPublished BIT," +
					"FeeEnabled BIT," +
