...
<%@ Page language="c#" CodeFile="DbContentCommentPage.aspx.cs" Inherits="Amns.GreyFox.ContentWeb.Administration.DbContentCommentPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DbContentCommentGrid id="DbContentCommentGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DbContentCommentGrid>
									<cc1:DbContentCommentEditor id="DbContentCommentEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DbContentCommentEditor>
									<cc1:DbContentCommentView id="DbContentCommentView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DbContentCommentView>
								</td>
							</tr>
							<tr>
