...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	...
	/// </summary>
	[ToolboxData("<DbContentCatalog:DbContentCatalogView runat=server></{0}:DbContentCatalogView>")]
	public class DbContentCatalogView : TableWindow, INamingContainer
	{
		...
		protected override void OnPreRender(EventArgs e)
		{
			if(dbContentCatalogID != 0)
			{
				...
				if(dbContentCatalog.ChildCatalogs != null)
					ltChildCatalogs.Text = dbContentCatalog.ChildCatalogs.ToString();
				else
					ltChildCatalogs.Text = string.Empty;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			RenderRow("row1", "DbContentCatalog ID", dbContentCatalogID.ToString());
