...
<%@ Page language="c#" CodeFile="DbContentClipPage.aspx.cs" Inherits="Amns.GreyFox.ContentWeb.Administration.DbContentClipPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:DbContentClipGrid id="DbContentClipGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:DbContentClipGrid>
									<cc1:DbContentClipEditor id="DbContentClipEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:DbContentClipEditor>
									<cc1:DbContentClipView id="DbContentClipView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:DbContentClipView>
								</td>
							</tr>
							<tr>
