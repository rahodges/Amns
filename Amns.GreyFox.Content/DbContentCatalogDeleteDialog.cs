...
namespace Amns.GreyFox.Content.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for DbContentCatalog.
	/// </summary>
	/// </summary>
	[ToolboxData("<DbContentCatalog:DbContentCatalogDeleteDialog runat=server></{0}:DbContentCatalogDeleteDialog>")]
	public class DbContentCatalogDeleteDialog : TableWindow
	{

		private int dbContentCatalogID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(dbContentCatalogID == 0)
			{
				...
				output.Write("The DbContentCatalog selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(dbContentCatalog.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
