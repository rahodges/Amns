...
<%@ Page language="c#" CodeFile="YariMediaTypePage.aspx.cs" Inherits="YariWeb.Administration.YariMediaTypePage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:YariMediaTypeGrid id="YariMediaTypeGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:YariMediaTypeGrid>
									<cc1:YariMediaTypeEditor id="YariMediaTypeEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:YariMediaTypeEditor>
									<cc1:YariMediaTypeView id="YariMediaTypeView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:YariMediaTypeView>
								</td>
							</tr>
							<tr>
