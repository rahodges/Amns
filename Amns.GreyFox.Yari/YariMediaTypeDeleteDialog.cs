...
namespace Amns.GreyFox.Yari.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for YariMediaType.
	/// </summary>
	/// </summary>
	[ToolboxData("<YariMediaType:YariMediaTypeDeleteDialog runat=server></{0}:YariMediaTypeDeleteDialog>")]
	public class YariMediaTypeDeleteDialog : TableWindow
	{

		private int yariMediaTypeID = -1;
		private YariMediaType yariMediaType;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(yariMediaTypeID == 0)
			{
				...
				output.Write("The YariMediaType selected does not exist.");
