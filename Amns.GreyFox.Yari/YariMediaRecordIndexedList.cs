...
namespace Amns.GreyFox.Yari
{
	...
	/// </summary>
	/// </summary>
	public class YariMediaRecordIndexedList : IList, ICloneable 
	{
		private int count = 0;
		private int[,] index;
		private YariMediaRecord[] YariMediaRecordArray ;

		public YariMediaRecordIndexedList() : base()
		{
			index = new int[15,2];
			YariMediaRecordArray = new YariMediaRecord[15];
		}

		public YariMediaRecordIndexedList(int capacity) : base()
		{
		...
		public void RemoveAt(int index)
		{
			...
			lock(this)
			{
				removeIndexKey(YariMediaRecordArray[index].ID);
