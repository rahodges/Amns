<%@ Register TagPrefix="cc1" Namespace="Amns.GreyFox.Yari.Web.UI.WebControls" Assembly="Amns.GreyFox.Yari" %>
<%@ Page language="c#" CodeFile="YariMediaKeywordPage.aspx.cs" Inherits="YariWeb.Administration.YariMediaKeywordPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:YariMediaKeywordGrid id="YariMediaKeywordGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:YariMediaKeywordGrid>
									<cc1:YariMediaKeywordEditor id="YariMediaKeywordEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:YariMediaKeywordEditor>
									<cc1:YariMediaKeywordView id="YariMediaKeywordView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:YariMediaKeywordView>
								</td>
							</tr>
							<tr>
