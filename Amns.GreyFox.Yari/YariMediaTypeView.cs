...
namespace Amns.GreyFox.Yari.Web.UI.WebControls
{
	...
	/// </summary>
	[ToolboxData("<YariMediaType:YariMediaTypeView runat=server></{0}:YariMediaTypeView>")]
	public class YariMediaTypeView : TableWindow, INamingContainer
	{
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			RenderRow("row1", "YariMediaType ID", yariMediaTypeID.ToString());
