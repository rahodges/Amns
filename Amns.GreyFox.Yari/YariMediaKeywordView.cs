...
namespace Amns.GreyFox.Yari.Web.UI.WebControls
{
	...
	/// </summary>
	[ToolboxData("<YariMediaKeyword:YariMediaKeywordView runat=server></{0}:YariMediaKeywordView>")]
	public class YariMediaKeywordView : TableWindow, INamingContainer
	{
		...
		private Literal ltKeyword = new Literal();
		...
		protected override void CreateChildControls()
		{
			...
			ltKeyword.EnableViewState = false;
			Controls.Add(ltKeyword);
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			...
			RenderRow("row1", "YariMediaKeyword ID", yariMediaKeywordID.ToString());
		...
		private void renderDefaultFolder(HtmlTextWriter output)
		{
			...
			output.Write(HtmlTextWriter.TagRightChar);
			ltKeyword.RenderControl(output);
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
