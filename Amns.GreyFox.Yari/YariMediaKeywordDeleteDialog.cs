...
namespace Amns.GreyFox.Yari.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for YariMediaKeyword.
	/// </summary>
	/// </summary>
	[ToolboxData("<YariMediaKeyword:YariMediaKeywordDeleteDialog runat=server></{0}:YariMediaKeywordDeleteDialog>")]
	public class YariMediaKeywordDeleteDialog : TableWindow
	{

		private int yariMediaKeywordID = -1;
		private YariMediaKeyword yariMediaKeyword;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(yariMediaKeywordID == 0)
			{
				...
				output.Write("The YariMediaKeyword selected does not exist.");
