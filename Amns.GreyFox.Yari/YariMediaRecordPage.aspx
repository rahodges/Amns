...
<%@ Page language="c#" CodeFile="YariMediaRecordPage.aspx.cs" Inherits="YariWeb.Administration.YariMediaRecordPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:YariMediaRecordGrid id="YariMediaRecordGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:YariMediaRecordGrid>
									<cc1:YariMediaRecordEditor id="YariMediaRecordEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:YariMediaRecordEditor>
									<cc1:YariMediaRecordView id="YariMediaRecordView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:YariMediaRecordView>
								</td>
							</tr>
							<tr>
