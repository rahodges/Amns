...
namespace Amns.GreyFox.Security.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for GreyFoxUser.
	/// </summary>
	/// </summary>
	[ToolboxData("<GreyFoxUser:GreyFoxUserDeleteDialog runat=server></{0}:GreyFoxUserDeleteDialog>")]
	public class GreyFoxUserDeleteDialog : TableWindow
	{

		private int greyFoxUserID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(greyFoxUserID == 0)
			{
				...
				output.Write("The GreyFoxUser selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(greyFoxUser.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
