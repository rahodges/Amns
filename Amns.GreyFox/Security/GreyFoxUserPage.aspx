...
<%@ Page language="c#" CodeFile="GreyFoxUserPage.aspx.cs" Inherits="GreyFoxWeb.Administration.GreyFoxUserPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:GreyFoxUserGrid id="GreyFoxUserGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:GreyFoxUserGrid>
									<cc1:GreyFoxUserEditor id="GreyFoxUserEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:GreyFoxUserEditor>
									<cc1:GreyFoxUserView id="GreyFoxUserView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:GreyFoxUserView>
								</td>
