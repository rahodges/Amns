<%@ Register TagPrefix="cc1" Namespace="Amns.GreyFox.Web.UI.WebControls" Assembly="Amns.GreyFox" %>
<%@ Page language="c#" Codebehind="GreyFoxUserPreferencePage.aspx.cs" Inherits="GreyFoxWeb.Administration.GreyFoxUserPreferencePage" AutoEventWireup="false" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:GreyFoxUserPreferenceGrid id="GreyFoxUserPreferenceGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:GreyFoxUserPreferenceGrid>
									<cc1:GreyFoxUserPreferenceEditor id="GreyFoxUserPreferenceEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:GreyFoxUserPreferenceEditor>
									<cc1:GreyFoxUserPreferenceView id="GreyFoxUserPreferenceView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:GreyFoxUserPreferenceView>
								</td>
							</tr>
							<tr>
