...
<%@ Page language="c#" Codebehind="GreyFoxSettingPage.aspx.cs" Inherits="GreyFoxWeb.Administration.GreyFoxSettingPage" AutoEventWireup="false" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:GreyFoxSettingGrid id="GreyFoxSettingGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:GreyFoxSettingGrid>
									<cc1:GreyFoxSettingEditor id="GreyFoxSettingEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:GreyFoxSettingEditor>
									<cc1:GreyFoxSettingView id="GreyFoxSettingView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:GreyFoxSettingView>
								</td>
							</tr>
							<tr>
