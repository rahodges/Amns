...
namespace Amns.GreyFox.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for GreyFoxUserPreference.
	/// </summary>
	/// </summary>
	[ToolboxData("<GreyFoxUserPreference:GreyFoxUserPreferenceDeleteDialog runat=server></{0}:GreyFoxUserPreferenceDeleteDialog>")]
	public class GreyFoxUserPreferenceDeleteDialog : TableWindow
	{

		private int greyFoxUserPreferenceID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(greyFoxUserPreferenceID == 0)
			{
				...
				output.Write("The GreyFoxUserPreference selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(greyFoxUserPreference.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
