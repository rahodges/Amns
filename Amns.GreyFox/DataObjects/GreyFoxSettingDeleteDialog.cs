...
namespace Amns.GreyFox.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for GreyFoxSetting.
	/// </summary>
	/// </summary>
	[ToolboxData("<GreyFoxSetting:GreyFoxSettingDeleteDialog runat=server></{0}:GreyFoxSettingDeleteDialog>")]
	public class GreyFoxSettingDeleteDialog : TableWindow
	{

		private int greyFoxSettingID = -1;
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(greyFoxSettingID == 0)
			{
				...
				output.Write("The GreyFoxSetting selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(greyFoxSetting.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
