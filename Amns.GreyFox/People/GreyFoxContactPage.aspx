<%@ Register TagPrefix="cc1" Namespace="Amns.GreyFox.People.Web.UI.WebControls" Assembly="Amns.GreyFox.People" %>
<%@ Page language="c#" CodeFile="GreyFoxContactPage.aspx.cs" Inherits="GreyFoxWeb.Administration.GreyFoxContactPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:GreyFoxContactGrid id="GreyFoxContactGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:GreyFoxContactGrid>
									<cc1:GreyFoxContactEditor id="GreyFoxContactEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:GreyFoxContactEditor>
									<cc1:GreyFoxContactView id="GreyFoxContactView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:GreyFoxContactView>
								</td>
							</tr>
							<tr>
