...
function gfx_showtip(id){
	var tipObj = new getObj("gfx_tt_" + id).obj;
	gfx_starttip(tipObj.innerHTML, tipObj.style.backgroundColor, tipObj.style.width);	
}

function gfx_hidetip(){
	gfx_endtip();
}

function gfx_starttip(thetext, thecolor, thewidth){
	if (ns6||ie4){
