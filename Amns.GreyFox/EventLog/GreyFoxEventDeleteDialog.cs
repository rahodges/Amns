...
namespace Amns.GreyFox.EventLog.Web.UI.WebControls
{
	/// <summary>
	/// <summary>
	/// A delete dialog for GreyFoxEvent.
	/// </summary>
	/// </summary>
	[ToolboxData("<GreyFoxEvent:GreyFoxEventDeleteDialog runat=server></{0}:GreyFoxEventDeleteDialog>")]
	public class GreyFoxEventDeleteDialog : TableWindow
	{
		private string tableName = "sysGlobal_EventLog";

		private int greyFoxEventID = -1;
		...
		{
			GreyFoxEvent greyFoxEvent = new GreyFoxEvent(greyFoxEventID);
			greyFoxEvent.Delete();
		...
		protected override void OnPreRender(EventArgs e)
		{
			if(greyFoxEventID != 0)
			{
				greyFoxEvent = new GreyFoxEvent(greyFoxEventID);
				text = "Delete - " + greyFoxEvent.ToString();
			}
			else
			{
				text = "Delete ";
		...
		protected override void RenderContent(HtmlTextWriter output)
		{
			if(greyFoxEventID == 0)
			{
				...
				output.Write("The GreyFoxEvent selected does not exist.");
			...
			output.Write(HtmlTextWriter.TagRightChar);
			output.Write(greyFoxEvent.ToString());
			output.WriteEndTag("td");
			output.WriteEndTag("tr");
