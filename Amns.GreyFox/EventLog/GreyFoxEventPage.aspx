<%@ Register TagPrefix="cc1" Namespace="Amns.GreyFox.EventLog.Web.UI.WebControls" Assembly="Amns.GreyFox.EventLog" %>
<%@ Page language="c#" CodeFile="GreyFoxEventPage.aspx.cs" Inherits="GreyFoxWeb.Administration.GreyFoxEventPage" trace="false" %>
						...
						<table id="Table1" cellSpacing="0" cellPadding="3" width="100%" border="0" height="100%">
							...
							<tr>
								...
								<td vAlign="top" width="100%">
									<cc1:GreyFoxEventGrid id="GreyFoxEventGrid1" runat="server" Width="100%" BorderWidth="0px" Height="100%" 
										...
										Text=""
										></cc1:GreyFoxEventGrid>
									<cc1:GreyFoxEventEditor id="GreyFoxEventEditor1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" Editor"
										></cc1:GreyFoxEventEditor>
									<cc1:GreyFoxEventView id="GreyFoxEventView1" runat="server" Width="100%" BorderWidth="0px"
										CellSpacing="1px" CellPadding="3px" CssClass="forumLine" HeaderCssClass="thHead" SubHeaderCssClass="catHead" Visible="false"
										Text=" View"
										></cc1:GreyFoxEventView>
								</td>
							</tr>
							<tr>
