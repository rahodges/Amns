...
//			PropertyItem newItem;
		...
		public static void WriteDescription(string filename, string newAuthor, string newCopyright, string newDescription)
		{
			writeDescriptionInImage(filename, newAuthor, newCopyright, newDescription);
		}

		private static void writeDescriptionInImage(string filename, string newAuthor, string newCopyright, string newDescription)
		{
			Image Pic;
			PropertyItem[] PropertyItems;
			byte[] bAuthor=new Byte[newAuthor.Length];
			...
			for (i=0;i<newAuthor.Length;i++) bAuthor[i]=(byte)newAuthor[i];
